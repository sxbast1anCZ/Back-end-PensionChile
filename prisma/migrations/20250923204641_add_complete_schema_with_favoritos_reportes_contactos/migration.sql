...
CREATE TABLE "public"."contactos" (
    "id" SERIAL NOT NULL,
    "publicacionId" INTEGER NOT NULL,
    "universitarioId" INTEGER NOT NULL,
    "propietarioId" INTEGER NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "favoritos_usuarioId_publicacionId_key" ON "public"."favoritos"("usuarioId", "publicacionId");

-- CreateIndex
CREATE UNIQUE INDEX "reportes_publicacionId_usuarioId_key" ON "public"."reportes"("publicacionId", "usuarioId");

-- CreateIndex
CREATE INDEX "contactos_propietarioId_fechaEnvio_idx" ON "public"."contactos"("propietarioId", "fechaEnvio");

-- CreateIndex
CREATE INDEX "contactos_universitarioId_fechaEnvio_idx" ON "public"."contactos"("universitarioId", "fechaEnvio");

-- CreateIndex
CREATE INDEX "contactos_publicacionId_fechaEnvio_idx" ON "public"."contactos"("publicacionId", "fechaEnvio");
...
-- AddForeignKey
ALTER TABLE "public"."favoritos" ADD CONSTRAINT "favoritos_usuarioId_fkey" FOREIGN KEY ("usuarioId") REFERENCES "public"."usuarios"("idUsuario") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."favoritos" ADD CONSTRAINT "favoritos_publicacionId_fkey" FOREIGN KEY ("publicacionId") REFERENCES "public"."publicaciones"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."reportes" ADD CONSTRAINT "reportes_publicacionId_fkey" FOREIGN KEY ("publicacionId") REFERENCES "public"."publicaciones"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."reportes" ADD CONSTRAINT "reportes_usuarioId_fkey" FOREIGN KEY ("usuarioId") REFERENCES "public"."usuarios"("idUsuario") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."contactos" ADD CONSTRAINT "contactos_publicacionId_fkey" FOREIGN KEY ("publicacionId") REFERENCES "public"."publicaciones"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."contactos" ADD CONSTRAINT "contactos_universitarioId_fkey" FOREIGN KEY ("universitarioId") REFERENCES "public"."usuarios"("idUsuario") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."contactos" ADD CONSTRAINT "contactos_propietarioId_fkey" FOREIGN KEY ("propietarioId") REFERENCES "public"."usuarios"("idUsuario") ON DELETE CASCADE ON UPDATE CASCADE;
